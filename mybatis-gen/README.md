...
<generatorConfiguration>
    ...
    <context id="lpf_mysql_tables" targetRuntime="MyBatis3">
        ...
        <!--connectionURL="jdbc:mysql://100.95.129.189:32080/crm-sky?useUnicode=true&amp;characterEncoding=UTF-8&amp;allowMultiQueries=true"-->
        ...
        <!-- 数据表对应的model层  -->
        <javaModelGenerator targetPackage="dev.term.entity" targetProject="src/main/java">
        ...
        <sqlMapGenerator targetPackage="dev.term.mapper.xml" targetProject="src/main/java">
            <property name="enableSubPackages" value="true"/>
        </sqlMapGenerator>
        ...
        <javaClientGenerator type="XMLMAPPER" targetPackage="dev.term.mapper" targetProject="src/main/java">
            <!-- enableSubPackages:是否让schema作为包的后缀 -->
            <property name="enableSubPackages" value="true"/>
        </javaClientGenerator>

        <!-- 数据表进行生成操作 schema:相当于库名; tableName:表名; domainObjectName:对应的DO -->
        <table schema="crm-sky" tableName="t_term" domainObjectName="Term"
            ...
            <columnOverride column="effTime" jdbcType="DATETIME" javaType="java.sql.Timestamp"/>
            <columnOverride column="expTime" jdbcType="DATETIME" javaType="java.sql.Timestamp"/>
        </table>
        <!--有另外一张表-->
        <!--<table schema="crm-sky" tableName="t_term" domainObjectName="Term"-->
        <!--enableCountByExample="false" enableUpdateByExample="false"-->
...
### 参考
1. MyBatis Generator . http://mybatis.org/generator
